 ...
 */
function blogz_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function blogz_sanitize_css( $css ) {
 ...
 */
function blogz_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function blogz_sanitize_email( $email, $setting ) {
 ...
 */
function blogz_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function blogz_sanitize_html( $html ) {
 ...
 */
function blogz_sanitize_image( $image, $setting ) {
 ...
 */
function blogz_sanitize_nohtml( $nohtml ) {
 ...
 */
function blogz_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function blogz_sanitize_number_range( $number, $setting ) {
 ...
 */
function blogz_sanitize_select( $input, $setting ) {
 ...
 */
function blogz_sanitize_url( $url ) {
