...
class DataTable{
    ...
    function dataTable($params = array('items_per_page' => 10, 'title' => false, 'desc' => false, 'order_by' => 'date', 'order' => 'DESC', 'paging' => false, 'page_numbers' => true, 'toolbar' => 1, 'template' => '', 'cols' => "", 'colheads' => "", 'tags' => '', 'categories' => '', 'year' => '', 'month' => '', 's' => '', 'css_class' => 'wpdm_packages', 'scid' => '', 'async' => 1))
    {
        ...
        ob_start();
        include Template::locate("shortcodes/datatable.php", WPDM_TPL_FALLBACK);
    ...
    function output( $attributes, $content){
        if(version_compare(WPDM_Version, '5.0', '<')) return \WPDM_Messages::info("This  block is only available with <a href='https://www.wpdownloadmanager.com/pricing/' target=_blank >WordPress Download Manager Pro</a>", -1);
