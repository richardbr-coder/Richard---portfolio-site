...
})(jQuery); //I am a developer typing


var typedTextSpan = document.querySelector(".typed-text");
var cursorSpan = document.querySelector(".cursor");
var textArray = ["Developer", "Designer", "Programmer", "Musician", "Astronomer", "Photographer", "Drone Pilot", "Husband", "Dad"];
var typingDelay = 150;
...
function () {
  ...
  _createClass(Chart, [{
    key: "stylePath",
    value: function stylePath(target) {
      var d = "M".concat(this.R, ",0  A").concat(this.R, ",").concat(this.R, " 0 1,1 ").concat(this.R, ",-.01z");
      this.path.setAttributeNS(null, "d", d);
      this.pathLength = this.path.getTotalLength();
      this.unit = this.pathLength / this.divisions;
      this.strokeLength = this.start * this.unit;
      this.target = target * this.unit;
      this.path.style.strokeDasharray = "".concat(this.strokeLength, ",").concat(this.pathLength - this.strokeLength);
    }
  }, {
...
var charts = []; //Adjust the percentages in the circles in the interest section
