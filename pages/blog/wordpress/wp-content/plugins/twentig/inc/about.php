	...
	<div class="tw-about__container">
		...
		<div class="tw-about__section is-feature">
			<div class="tw-about__section-inner">
				...
				<?php $text = esc_html__( 'From advanced Twenty Twenty-One options to enhanced blocks to pre‑designed layouts, you’ve got what you need to create a beautiful website.', 'twentig' ); ?>
				<p>
					<?php
			...
			<div class="tw-about__section-inner">
				...
				if ( 'twentytwenty' !== $theme && 'twentytwentyone' !== $theme && current_user_can( 'switch_themes' ) ) {
					...
					if ( in_array( 'twentytwentyone', array_keys( $installed_themes ), true ) ) {
						...
						?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', esc_url( $install_url ), esc_html__( 'Activate Twenty Twenty-One', 'twentig' ) ); ?>
						<?php
					} else {
						$install_url = admin_url( 'theme-install.php?search=twentytwentyone' );
						?>
						<?php printf( '<a href="%s" class="button button-primary">%s</a>', esc_url( $install_url ), esc_html__( 'Install Twenty Twenty-One', 'twentig' ) ); ?>
						<?php
					}
				}
				?>
