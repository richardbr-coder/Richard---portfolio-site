	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<article id="skills">
				...
				<!-- Frameworks -->
				<h1 class="title-skills">Frameworks</h1>
				<div class="bar">
				...
				<!-- database -->
				<h1 class="title-skills">Database</h1>
				<div class="bar">
				...
				<!-- Tools -->
				<h1 class="title-skills">Tools/CSS Frameworks</h1>
				<div class="bar">
				...
				<form action="" id="form" method="post" name="form">
					<div class="fields">
						<div class="field half">
							...
							<input type="text" name="vname" id="name" required/>
						</div>
						<div class="field half">
							<label for="email">Email</label>
							<input type="text" name="vemail" id="email" required/>
						</div>
						<div class="field">
							<label for="message">Message</label>
							<textarea name="msg" id="message" rows="4" required></textarea>
						</div>
					</div>
					<ul class="actions">
